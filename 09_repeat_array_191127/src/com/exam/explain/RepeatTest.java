...
//		}
	...
	public void repeatTest4() {
		...
		String input="";		
		int averAge=0;
		double averHeight=0, averWeight=0;
		
		System.out.print("저장할 회원수를 입력 : ");
		...
		for(int i=0; i<memberCount; i++) {
			...
			input+=sc.nextLine();
			input+="\n";
			averAge+=Integer.parseInt(input.substring(4,6));
			averHeight+=Integer.parseInt(input.substring(16,19));
			averWeight+=Integer.parseInt(input.substring(22,24));
//			System.out.println(averAge);
//			System.out.println(averHeight);
//			System.out.println(averWeight);
		}
		
		System.out.println("================저장회원================");		
		System.out.println(input);
		System.out.println("평균 나이 : "+(averAge/memberCount));
		System.out.println("평균 키 : "+(averHeight/memberCount));
		System.out.println("평균  몸무게 : "+(averWeight/memberCount));
