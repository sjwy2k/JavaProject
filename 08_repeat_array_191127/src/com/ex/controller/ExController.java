	...
	public void crudProgram() {
		...
		do {
			...
			switch(select) {
				...
				case 7: System.out.println("프로그램을 종료합니다"); flag=true; break;
			}
		}while(!flag);
	}

	public void bunsikProgram() {
		
	}
	
	public void randomHundredNum() {
		Scanner sc=new Scanner(System.in);
